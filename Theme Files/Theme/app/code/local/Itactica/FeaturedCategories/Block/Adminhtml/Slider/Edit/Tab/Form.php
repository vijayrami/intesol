...
class Itactica_FeaturedCategories_Block_Adminhtml_Slider_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm(){
        ...
        $fieldset->addField('custom_classname', 'text', array(
            'label' => Mage::helper('itactica_featuredcategories')->__('Custom Class Name'),
            'name'  => 'custom_classname',
            'note'  => Mage::helper('itactica_featuredcategories')->__('Add a custom class name if you wish to further customize the widget style using CSS. Refer to this name on your custom.css file'),
            'class' => 'validate-code',
        ));

        $fieldset->addField('display_type', 'select', array(
            'label' => Mage::helper('itactica_featuredcategories')->__('Display Type'),
            'name'  => 'display_type',
            'class' => 'required-entry',
            'values'=> array(
                array(
                    'value' => 1,
                    'label' => Mage::helper('itactica_featuredcategories')->__('Slider'),
                ),
                array(
                    'value' => 0,
                    'label' => Mage::helper('itactica_featuredcategories')->__('Grid'),
                ),
            ),
        ));
