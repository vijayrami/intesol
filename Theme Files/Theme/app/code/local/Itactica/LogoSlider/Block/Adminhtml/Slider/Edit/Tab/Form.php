...
class Itactica_LogoSlider_Block_Adminhtml_Slider_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm(){
        ...
        $fieldset->addField('black_and_white', 'select', array(
            'label' => Mage::helper('itactica_logoslider')->__('Black & White Filter'),
            'name'  => 'black_and_white',
            'note'  => $this->__('If enabled, a B&W filter will be applied to all logos. Full color will be shown on mouseover'),
            'required'  => true,
            'class' => 'required-entry',
            'values'=> array(
                array(
