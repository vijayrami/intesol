 ...
 * set header config
 */
Mage::getConfig()->saveConfig('design/header/logo_src', 'images/logo-clothing.svg');
Mage::getConfig()->saveConfig('design/header/logo_src_small', 'images/logo-clothing.svg');
